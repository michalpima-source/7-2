    ...
    >
      ...
      <div className="flex flex-col items-center gap-3 mb-8">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground mt-1">צור חשבון והתחל להתאמן</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl border shadow-sm p-6 flex flex-col gap-5">
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <User className="absolute end-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground pointer-events-none" />
              <Input
                id="fullName"
                type="text"
                value={fullName}
          ...
          <Button type="submit" disabled={loading} className="mt-1 h-11 text-base font-medium w-full">
            {loading ? (
        ...
        <div className="text-center text-sm text-muted-foreground">
          כבר יש לך חשבון?{" "}
          <a href="/sign-in" className="text-primary font-medium hover:underline underline-offset-4">
            התחבר
          </a>
        </div>
      </div>
